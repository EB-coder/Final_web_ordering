#This is the online coffee ordering shop project.
 ...
 Take a look to the main page of this coffee shop:<br>
 This page is About this online shop.<br>
 we have: menu on the top, and Login and Register<br>
 ...
 Here is the login page actually for the Managers (not for the users), because the users can order without signing up!<br>
