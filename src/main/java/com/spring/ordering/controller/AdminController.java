...
public class AdminController {
    ...
    public String register(@ModelAttribute Account account) {
        ...
        try {
            ...
            String inserting= String.format("INSERT INTO accounts values ('%s',true,'%s','ROLE_MANAGER')",account.getUserName(),bCryptPasswordEncoder.encode(account.getEncrytedPassword()));
